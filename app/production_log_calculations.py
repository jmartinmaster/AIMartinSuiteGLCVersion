...
def get_ui(parent, dispatcher):
    ...
    raise RuntimeError("The Tk Form Calculations controller was removed from the live Phase 9 runtime. See shadow/app/controllers/production_log_calculations_controller.py.")