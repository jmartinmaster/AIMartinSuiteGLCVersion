...
__module_name__ = "Developer Admin Qt View"
__version__ = "1.0.0"


def is_developer_admin_qt_runtime_available():
    return PYQT6_AVAILABLE


def run_developer_admin_qt_session(session_path):
    ...
    controller = DeveloperAdminQtController(session_payload)
    controller.show()
